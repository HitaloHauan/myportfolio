        ...
        <body id='content' className="flex flex-col w-full h-full justify-center items-center" data-spy="scroll" data-target="#navbar" data-offset="50">
            ...
            >
                <div className="flex flex-col items-center justify-center py-5 px-5">
                    <img className='w-[310px] rounded-full border-4' src='https://thumbs2.imgbox.com/15/72/5JoO9WWu_t.jpg' alt="" />
                ...
                <div className="flex items-center flex-wrap justify-center px-5 py-5">
                    <p className="text-white font-bold text-[100px]">&lt;</p>
                    <p  className="text-white text-md max-w-[700px] text-justify px-4 py-4">Desenvolvedor Web Júnior com experiência de 9 meses de prestação de serviços,
               ...
               <div className="flex flex-wrap justify-center pb-10">
                    <div className="flex py-5 flex-wrap justify-center">
                        <div className="flex flex-col justfy-center items-center">
                            <img className="w-20 h-20 mx-4 my-4 hover:w-24 hover:my-0 hover:h-24 transition-[0.6s]" src="https://thumbs2.imgbox.com/c2/db/gXyKqZOr_t.png" alt="html" />
                            <span className="text-white cursor-default">HTML</span>
                        </div>
                        <div className="flex flex-col justfy-center items-center">
                            <img className="w-20 h-20 mx-4 my-4 hover:w-24 hover:my-0 hover:h-24 transition-[0.6s]" src="https://thumbs2.imgbox.com/d2/2f/T2Zm7nBr_t.png" alt="css" />
                            <span className="text-white cursor-default">CSS</span>
                        </div>
                        <div className="flex flex-col justfy-center items-center">
                            <img className="w-20 h-20 mx-4 my-4 hover:w-24 hover:my-0 hover:h-24 transition-[0.6s]" src="https://thumbs2.imgbox.com/22/bc/bclEIczu_t.png" alt="js" />
                            <span className="text-white cursor-default">JavaScript</span>
                        </div>
                    </div>
                    <div className="flex py-5 flex-wrap justify-center">
                        <div className="flex flex-col justfy-center items-center">
                            <img className="w-20 h-20 mx-4 my-4 hover:w-24 hover:my-0 hover:h-24 transition-[0.6s]" src="https://thumbs2.imgbox.com/c0/97/S4WTGlSh_t.png" alt="react" />
                            <span className="text-white cursor-default">ReactJs</span>
                        </div>
                        <div className="flex flex-col justfy-center items-center">
                            <img className="w-20 h-20 mx-4 my-4 hover:w-24 hover:my-0 hover:h-24 transition-[0.6s]" src="https://thumbs2.imgbox.com/56/92/NW7d5DJ1_t.png" alt="nodejs" />
                            <span className="text-white cursor-default">NodeJs</span>
                        </div>
                        <div className="flex flex-col justfy-center items-center">
                            <img className="w-20 h-20 mx-4 my-4 hover:w-24 hover:my-0 hover:h-24 transition-[0.6s]" src="https://thumbs2.imgbox.com/f5/fe/1ppiNpuS_t.png" alt="git" />
            ...
            <div id='projetos' className="flex flex-col justify-center items-center px-5 pb-10">
                ...
                <div className="flex justify-center items-center flex-wrap">
                    {/* projeto 1 */}
                    <Button onClick={handleOpen}><img className="w-[300px] rounded-[10px] hover:opacity-80" src="https://thumbs2.imgbox.com/f3/d1/PKALZJtu_t.jpg" alt="" /></Button>
                    <Modal
                        open={open}
                        onClose={handleClose}
                    ...
                    >
                        <Box sx={style}>
                            ...
                            <img className="w-[362px] rounded-[10px] mt-10" src="https://thumbs2.imgbox.com/f3/d1/PKALZJtu_t.jpg" alt="" />
                    ...
                    <Button onClick={handleOpen1}><img className="w-[300px] h-[300px] rounded-[10px] hover:opacity-80" src="https://thumbs2.imgbox.com/2a/59/PEPao1F5_t.png" alt="" /></Button>
                    <Modal
                        open={open1}
                    ...
                    >
                        <Box sx={style}>
                            ...
                            <img className="w-[362px] rounded-[10px] mt-10" src="https://thumbs2.imgbox.com/2a/59/PEPao1F5_t.png" alt="" />
                            <Typography id="modal-modal-description" className="text-white px-10 pt-5">
                    ...
                    <Button onClick={handleOpen2}><img className="w-[300px] rounded-[10px] hover:opacity-80" src="https://thumbs2.imgbox.com/1f/04/63bVNkNT_t.png" alt="" /></Button>
                    <Modal
                        open={open2}
                    ...
                    >
                        <Box sx={style}>
                            ...
                            <img className="w-[362px] rounded-[10px] mt-10" src="https://thumbs2.imgbox.com/1f/04/63bVNkNT_t.png" alt="" />
                            <Typography id="modal-modal-description" className="text-white px-10 pt-5">
